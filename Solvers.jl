...
include("dev partial/poly.jl")
include("dev partial/nanmath.jl")
include("dev partial/ad.jl")
include("dev partial/nlsolve.jl")
include("dev partial/fixpoint/fixpoint.jl")
include("dev partial/fixpoint/ADNewton.jl")
include("dev partial/fixpoint/anderson.jl")
include("dev partial/optimize.jl")
include("dev partial/integral.jl")
include("dev partial/chebyshev.jl")
include("dev partial/npipm.jl")
