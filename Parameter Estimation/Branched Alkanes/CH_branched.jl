...
function IB_viscosity_CH(model::EoSModel, P, T, z = StaticArrays.SA[1.0];
        ξ_i = Dict("CH3" => 0.606768956945666, "CH2" => 0.0647119131236987, "CH" => -0.38513990986004343, "C" => -0.4),
        tau_i = Dict("CH3" => 1.22178546172914, "CH2" => 1.32871198166777, "CH" => 1.6138758011510976, "C" => 0.8),
       n_g_1 = 3.738183154, n_g_2 = -3.206334125, n_g_3 = 1.06823180395187)
...
function make_global_objective(models::Vector, datasets::Vector{DataFrame})
    ...
    function objective(x)
        ...
        ξ_i = Dict("CH3" => 0.606768956945666, "CH2" => 0.0647119131236987, "CH" => x[1], "C" => 0.0)
        tau_i = Dict("CH3" => 1.22178546172914, "CH2" => 1.32871198166777, "CH" => x[2], "C" => 0.0 )
        n_g_1 = 3.73818315395826
        n_g_2 = -3.20633412516994
        n_g_3 = 1.06823180395187
        total_error = 0.0
