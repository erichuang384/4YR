...
function optimize_bell_parameters!(models, datasets;
    lower = [-1, -100, -1, 0.0, 0.0, 0.0],
    upper = [ 1,  100, 150, 1.0, 1.0, 1.0],
    ...
    x0 = [0.044688722, -0.388263619, 0.717555063, 0.199109905, 0.214250253,	1.289634421]
...
# === Example Usage ===
models = [
    SAFTgammaMie(["2,2,4-trimethylpentane"]), # C
    ...
    SAFTgammaMie(["heptamethylnonane"]), # C
