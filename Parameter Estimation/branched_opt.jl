...
m1_fix, m2_fix, m3_fix = (-0.07020613988459963, 0.4526929704410887, -1.6734960099036927e-5, -0.6976576704156878, 0.3681270045188838, 9.30920589170978e-5, 1.040106781887901, 1.5674091869700848e-5, -1.999341455459331e-6, -20.2637266914618, 38.55028392360753, 26.27614884148527)
A_CH3_0, B_CH3_0, C_CH3_0,
A_CH2_0, B_CH2_0, C_CH2_0,
gamma_fix, D_i,
...
x0 = [-0.9385800472091962, 0.2628502956068002, 0.0019599739052107427, 0.0]
...
function sse_CH_only(params::AbstractVector{<:Real})
    ...
    for i in 1:length(models)
        ...
        # Model terms
        n_g1 = A_vdw_opt(models[i], A_CH3_0, A_CH2_0,A_CH,0.0)
