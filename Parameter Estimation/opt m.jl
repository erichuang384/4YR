...
A_CH3, B_CH3, C_CH3, A_CH2, B_CH2, C_CH2, gamma_i, D_CH3, D_CH2 = 0.1890961234814139, 5.474948185690605e-5, -0.0004881298485700812, -0.7872935468705283, -3.1805132878274554e-6, 0.000215347254470103, -0.9564407262673263, 0.00014388630715398998, -6.69573573972837e-6
# ---------------------------------------------------------------------
...
function sse_m_only(m_vec::AbstractVector{<:Real})
    ...
    for i in 1:length(models)
        ...
        n_g3 = (C_CH3 * num_CH3 + C_CH2 * num_CH2).* (1 .+ m_i .* ((T .- T_C)./ T_C).^3)
